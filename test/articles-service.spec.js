...
describe(`Articles service object`, function () {
  ...
  before(() => db('blogful_articles').truncate()) //empties the database before testing

  afterEach(() => db('blogful_articles').truncate()) //empties the database after each test in scope
